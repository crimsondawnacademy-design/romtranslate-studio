...
| Reinserção (adapter RTSF) | pronto (round-trip testado) | `crates/core/src/{adapters/rtsf,reinsert}.rs` | padrões p/ adapters reais |
| Sprint 6 (patch export) | não começou | spec §16 | IPS + manifest |
